...
#ifndef TENSORFLOW_CORE_DISTRIBUTED_RUNTIME_RPC_GRPC_MASTER_SERVER_LIB_H_
#define TENSORFLOW_CORE_DISTRIBUTED_RUNTIME_RPC_GRPC_MASTER_SERVER_LIB_H_

// GrpcMastewrServer manages the lifecycle of an Worker service.
...
class GrpcMasterServer : public ServerInterface {
 protected:
  GrpcMasterServer(const ServerDef& server_def, Env* env);
 ...
 public:
  ...
  Master* master_impl() const { return master_impl_.get(); }

  AsyncServiceInterface* worker_service() const { return worker_service_; }
...
#endif  // TENSORFLOW_CORE_DISTRIBUTED_RUNTIME_RPC_GRPC_MASTER_SERVER_LIB_H_
